...
(
    ...
    USERID           varchar(36)  not null comment '用户ID',
    LOGINTIME        datetime(6)     not null comment '登录时间',
    LOGOUTTIME       datetime(6)   not null comment '退出时间',
...
(
    ...
    OPTIME            datetime(6)    not null comment '操作时间',
...
(
    ...
    CREATETIME       datetime(6) comment '创建时间',
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, `SYSTEM`, newtype) VALUES ('安全策略', 'SECURITYPOLICY', '登录均可访问', '1', NULL, 2, '0', NULL, NULL, NULL, now(), '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, `SYSTEM`, newtype) VALUES ('安全策略', 'SECURITYPOLICY', '授权可访问', '2', NULL, 3, '0', NULL, NULL, NULL, now(), '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, `SYSTEM`, newtype) VALUES ('权限认证方式', 'AUTHMODE', 'Key盘', '04', NULL, 1, '0', NULL, NULL, NULL, now(), '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, `SYSTEM`, newtype) VALUES ('模版类型', 'TEMPLATETYPE', '表单模板', '1', NULL, 10, '0', NULL, NULL, NULL, now(), '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, `SYSTEM`, newtype) VALUES ('功能配置', 'CONFIGFUNCTIONCATEGORY', 'web安全配置', 'ta404.component.security', NULL, 60, '0', NULL, NULL, NULL, now(), '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
