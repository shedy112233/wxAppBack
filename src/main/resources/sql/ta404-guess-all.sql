...
(
    ...
    syscode           VARCHAR2(20 char)  NOT NULL,
    sysname           VARCHAR2(100 char) NOT NULL,
    spell             VARCHAR2(30 char),
    protocol          VARCHAR2(10 char),
    domain            VARCHAR2(100 char),
    port              VARCHAR2(5 char),
    contextpath       VARCHAR2(30 char),
    portalsystem      VARCHAR2(1 char),
    menuservice       VARCHAR2(200 char),
    provider          VARCHAR2(50 char),
    effective         VARCHAR2(1 char)   NOT NULL,
    regtime           DATE,
    modifytime        DATE,
    backgroundaddress VARCHAR2(100 char),
    field01             VARCHAR2(1000 char),
    field02             VARCHAR2(1000 char),
    field03             VARCHAR2(1000 char),
    field04             VARCHAR2(1000 char),
    field05             VARCHAR2(1000 char),
    field06             VARCHAR2(1000 char),
    field07             VARCHAR2(1000 char),
    field08             VARCHAR2(1000 char),
    field09             VARCHAR2(1000 char),
    field10             VARCHAR2(1000 char),
    constraint PK_taaccesssystem primary key (id)
) distribute by replication on groupid(1);
...
CREATE TABLE taarea
(
    areaid     VARCHAR2(36 char)  NOT NULL,
    parentid   VARCHAR2(36 char)  NOT NULL,
    areaname   VARCHAR2(100 char) NOT NULL,
    areacode   VARCHAR2(20 char)  NOT NULL,
    idpath     VARCHAR2(1024 char) NOT NULL,
    namepath   VARCHAR2(1024 char) NOT NULL,
    arealevel  DECIMAL(2, 0),
    spell      VARCHAR2(100 char),
    createuser VARCHAR2(36 char)  NOT NULL,
    areaorder  DECIMAL(20, 0),
    effective  VARCHAR2(1 char)   NOT NULL,
    createtime DATE          NOT NULL,
    modifytime DATE          NOT NULL,
    destory    VARCHAR2(1 char)   NOT NULL,
...
(
    userid     VARCHAR2(36 char) NOT NULL,
    avatar     BLOB,
...
(
    customorgid         VARCHAR2(36 char) NOT NULL,
    parentid            VARCHAR2(36 char),
    customcode          VARCHAR2(255 char),
    customorgtypenameid VARCHAR2(36 char) NOT NULL,
    effective           VARCHAR2(1 char)  NOT NULL,
    orderno             DECIMAL(10, 0),
    customorgname       VARCHAR2(255 char),
    customorgpathid     VARCHAR2(1024 char),
    customorgpath       VARCHAR2(1024 char),
    createuser          VARCHAR2(36 char) NOT NULL,
    createtime          DATE         NOT NULL,
    updatetime          DATE         NOT NULL,
    destory             VARCHAR2(1 char)  NOT NULL,
    spell               VARCHAR2(255 char),
    orgmanager          VARCHAR2(36 char),
    orgcode             VARCHAR2(18 char),
    contacts            VARCHAR2(36 char),
    address             VARCHAR2(450 char),
...
(
    customorgtypenameid   VARCHAR2(36 char),
    customorgtypename     VARCHAR2(36 char),
    effective             VARCHAR2(1 char)  NOT NULL,
    createuser            VARCHAR2(36 char) NOT NULL,
    createtime            DATE         NOT NULL,
    updatetime            DATE         NOT NULL,
    destory               VARCHAR2(1 char)  NOT NULL,
    customorgtypenamecode VARCHAR2(255 char),
    customorgtypenamedesc VARCHAR2(255 char),
...
(
    customresourceid VARCHAR2(36 char)  NOT NULL,
    resourcename     VARCHAR2(450 char) NOT NULL,
    parentid         VARCHAR2(36 char)  NOT NULL,
    code             VARCHAR2(100 char),
    resourcecontent  VARCHAR2(255 char),
    resourcecategory VARCHAR2(36 char),
    effective        VARCHAR2(1 char)   NOT NULL,
    addtime          DATE,
    modifytime       DATE,
    system           VARCHAR2(36 char),
...
(
    ...
    parentvalue VARCHAR2(50 char),
    sort        DECIMAL(4, 0) NOT NULL,
    authority   VARCHAR2(20 char)  NOT NULL,
    cssclass    VARCHAR2(128 char),
    cssstyle    VARCHAR2(128 char),
    remarks     VARCHAR2(256 char),
    createdate  DATE          NOT NULL,
    createuser  VARCHAR2(36 char)  NOT NULL,
    version     VARCHAR2(10 char)  NOT NULL,
    status      VARCHAR2(2 char)   NOT NULL,
    field01     VARCHAR2(10 char),
    field02     VARCHAR2(10 char),
    field03     VARCHAR2(10 char),
    field04     VARCHAR2(10 char),
    field05     VARCHAR2(10 char),
    system      VARCHAR2(2 char)   NOT NULL,
    newtype     VARCHAR2(2 char)   NOT NULL,
...
(
    fieldid        VARCHAR2(10 char) NOT NULL,
    type           VARCHAR2(2 char)  NOT NULL,
    effective      VARCHAR2(1 char)  NOT NULL,
    hide           VARCHAR2(1 char),
    displaytext    VARCHAR2(150 char),
    titext         VARCHAR2(1500 char),
    orderno        DECIMAL(10, 0),
    required       VARCHAR2(1 char),
    unchangeable   VARCHAR2(1 char),
    formtype       VARCHAR2(20 char),
    contentsize    DECIMAL(16, 0),
    validreg       VARCHAR2(1000 char),
    connectaa10    VARCHAR2(30 char),
    protectprivacy VARCHAR2(1 char),
    protectprivacyrule VARCHAR2(20 char),
    formid         VARCHAR2(10 char) NOT NULL,
    more           VARCHAR2(1 char),
...
(
    logid            VARCHAR2(36 char)  NOT NULL,
    userid           VARCHAR2(36 char)  NOT NULL,
    logintime        DATE          NOT NULL,
    logouttime       DATE          NOT NULL,
    clientip         VARCHAR2(200 char) NOT NULL,
    sessionid        VARCHAR2(200 char) NOT NULL,
    serverip         VARCHAR2(200 char),
    syspath          VARCHAR2(50 char),
    clientsystem     VARCHAR2(50 char),
    clientbrowser    VARCHAR2(50 char),
    clientscreensize VARCHAR2(50 char),
    hashverity       VARCHAR2(200 char),
...
(
    statdate    VARCHAR2(20 char) NOT NULL,
    pointintime VARCHAR2(20 char) NOT NULL,
...
(
    ...
    objecttype VARCHAR2(3 char)  NOT NULL,
    tagid      VARCHAR2(36 char) NOT NULL,
...
(
    ...
    userid           VARCHAR2(36 char)  NOT NULL,
    logintime        DATE          NOT NULL,
    curresource      VARCHAR2(1000 char),
    clientip         VARCHAR2(200 char) NOT NULL,
    sessionid        VARCHAR2(200 char) NOT NULL,
    syspath          VARCHAR2(50 char),
    serverip         VARCHAR2(200 char),
...
CREATE TABLE taorg
(
    orgid      VARCHAR2(36 char)   NOT NULL,
    orgname    VARCHAR2(200 char)  NOT NULL,
    spell      VARCHAR2(100 char)  NOT NULL,
    parentid   VARCHAR2(36 char)   NOT NULL,
    idpath     VARCHAR2(1024 char) NOT NULL,
    namepath   VARCHAR2(1024 char) NOT NULL,
    customno   VARCHAR2(30 char),
    orderno    DECIMAL(10, 0) NOT NULL,
    orglevel   DECIMAL(16, 0),
    area       VARCHAR2(36 char),
    effective  VARCHAR2(1 char)    NOT NULL,
    orgtype    VARCHAR2(2 char)    NOT NULL,
    createuser VARCHAR2(36 char)   NOT NULL,
    createtime DATE,
    modifytime DATE,
    orgmanager VARCHAR2(36 char),
...
(
    logid             VARCHAR2(36 char) NOT NULL,
    batchno           VARCHAR2(36 char) NOT NULL,
    optype            VARCHAR2(2 char)  NOT NULL,
    influencebodytype VARCHAR2(2 char)  NOT NULL,
    influencebody     VARCHAR2(36 char) NOT NULL,
    opbodytype        VARCHAR2(2 char),
    opsubject         VARCHAR2(36 char),
    changecontent     BLOB,
    optime            DATE         NOT NULL,
    opuser            VARCHAR2(36 char) NOT NULL,
    ispermission      VARCHAR2(1 char)  NOT NULL,
    hashverity        VARCHAR2(200 char),
...
(
    resourceid        VARCHAR2(36 char)   NOT NULL,
    presourceid       VARCHAR2(36 char)   NOT NULL,
    ...
    idpath            VARCHAR2(1024 char) NOT NULL,
    namepath          VARCHAR2(1024 char) NOT NULL,
    resourcelevel     VARCHAR2(2 char)    NOT NULL,
    icon              VARCHAR2(30 char),
    iconcolor         VARCHAR2(7 char),
    securitypolicy    VARCHAR2(2 char)    NOT NULL,
    securitylevel     DECIMAL(4, 0)  NOT NULL,
    resourcetype      VARCHAR2(2 char)    NOT NULL,
    effective         VARCHAR2(1 char)    NOT NULL,
    isdisplay         VARCHAR2(1 char),
    isfiledscontrol   VARCHAR2(1 char),
    createdate        DATE           NOT NULL,
    createuser        VARCHAR2(36 char)   NOT NULL,
    uiauthoritypolicy VARCHAR2(2 char),
    field01           VARCHAR2(10 char),
    field02           VARCHAR2(10 char),
    field03           VARCHAR2(10 char),
    field04           VARCHAR2(10 char),
    field05           VARCHAR2(10 char),
    field06           VARCHAR2(10 char),
    field07           VARCHAR2(10 char),
    field08           VARCHAR2(10 char),
    field09           VARCHAR2(10 char),
    field10           VARCHAR2(10 char),
    workbench         VARCHAR2(1 char),
    image             BLOB,
...
(
    categoryid      VARCHAR2(36 char)  NOT NULL,
    categoryname    VARCHAR2(300 char) NOT NULL,
    effective       VARCHAR2(1 char)   NOT NULL,
    code            VARCHAR2(100 char),
    categorycontent VARCHAR2(255 char),
...
(
    pageelementid   VARCHAR2(36 char) NOT NULL,
    resourceid      VARCHAR2(36 char) NOT NULL,
    elenmentname    VARCHAR2(20 char) NOT NULL,
    elementid       VARCHAR2(30 char) NOT NULL,
    code            VARCHAR2(20 char),
    authoritypolicy VARCHAR2(2 char)  NOT NULL,
    createuser      VARCHAR2(36 char) NOT NULL,
    createdate      DATE         NOT NULL,
    field01         VARCHAR2(10 char),
    field02         VARCHAR2(10 char),
...
(
    RESOURCEID      VARCHAR2(36 char) not null,
    URLID           VARCHAR2(36 char) not null,
    AUTHORITYPOLICY VARCHAR2(1 char)  not null,
...
(
    roleid        VARCHAR2(36 char)  NOT NULL,
    rolename      VARCHAR2(150 char) NOT NULL,
    isadmin       VARCHAR2(1 char),
    rolelevel     DECIMAL(32, 0),
    orgid         VARCHAR2(36 char)  NOT NULL,
    roletype      VARCHAR2(2 char)   NOT NULL,
    effective     VARCHAR2(1 char)   NOT NULL,
    effectivetime DATE,
    createuser    VARCHAR2(36 char)  NOT NULL,
    createtime    DATE,
    roledesc      VARCHAR2(150 char),
    rolesign      VARCHAR2(2 char),
    subordinate   VARCHAR2(1 char),
...
(
    roleid        VARCHAR2(36 char) NOT NULL,
    resourceid    VARCHAR2(36 char) NOT NULL,
    resourcetype  VARCHAR2(1 char)  NOT NULL,
    usepermission VARCHAR2(1 char),
    repermission  VARCHAR2(1 char),
    reauthrity    VARCHAR2(1 char),
    createuser    VARCHAR2(36 char) NOT NULL,
    createtime    DATE,
    effecttime    DATE,
...
(
    ...
    resourceid VARCHAR2(36 char) NOT NULL,
    urlid      VARCHAR2(36 char) NOT NULL,
    constraint PK_taroleurlauthority primary key (roleid, urlid, resourceid)
) distribute by replication on groupid(1);
...
(
    logid            VARCHAR2(50 char) NOT NULL,
    ipaddress        VARCHAR2(100 char),
    port             VARCHAR2(10 char),
    exceptionname    VARCHAR2(255 char),
    content          BLOB,
    createtime       DATE,
    syspath          VARCHAR2(50 char),
    clientip         VARCHAR2(50 char),
    url              VARCHAR2(100 char),
    menuid           VARCHAR2(50 char),
    menuname         VARCHAR2(30 char),
    useragent        VARCHAR2(200 char),
...
(
    taggroupid   VARCHAR2(36 char)  NOT NULL,
    taggroupname VARCHAR2(255 char) NOT NULL,
    effective    VARCHAR2(1 char)   NOT NULL,
    createuser   VARCHAR2(36 char)  NOT NULL,
    createtime   DATE          NOT NULL,
    updatetime   DATE          NOT NULL,
...
(
    userid             VARCHAR2(36 char)  NOT NULL,
    loginid            VARCHAR2(30 char)  NOT NULL,
    password           VARCHAR2(100 char) NOT NULL,
    passworddefaultnum DECIMAL(16, 0),
    pwdlastmodifydate  DATE,
    islock             VARCHAR2(1 char),
    orderno            DECIMAL(10, 0),
    name               VARCHAR2(450 char) NOT NULL,
    sex                VARCHAR2(2 char),
    idcardtype         VARCHAR2(2 char),
    idcardno           VARCHAR2(30 char),
    mobile             VARCHAR2(20 char),
    createuser         VARCHAR2(36 char)  NOT NULL,
    createtime         DATE,
    modifytime         DATE,
    destory            VARCHAR2(1 char)   NOT NULL,
    accountsource      VARCHAR2(2 char),
    effective          VARCHAR2(1 char)   NOT NULL,
    effectivetime      DATE,
    jobnumber          VARCHAR2(15 char),
    state              VARCHAR2(10 char),
    birthplace         VARCHAR2(12 char),
    address            VARCHAR2(450 char),
    zipcode            VARCHAR2(10 char),
    email              VARCHAR2(100 char),
    phone              VARCHAR2(20 char),
    education          VARCHAR2(30 char),
    graduateschool     VARCHAR2(150 char),
    workplace          VARCHAR2(300 char),
    field01            VARCHAR2(1000 char),
    field02            VARCHAR2(1000 char),
    field03            VARCHAR2(1000 char),
    field04            VARCHAR2(1000 char),
...
(
    ...
    isdirect VARCHAR2(1 char)  NOT NULL,
...
(
    ZKID         VARCHAR2(36 char) not null,
    ZKADDRESS    VARCHAR2(200 char),
    APPNAME      VARCHAR2(60 char),
    APPNAMESPACE VARCHAR2(30 char),
    CONNECTFLAG  VARCHAR2(1 char),
...
(
    DATASOURCEID   VARCHAR2(36 char) not null,
    DATASOURCENAME VARCHAR2(60 char),
    DRIVER         VARCHAR2(200 char),
    URL            VARCHAR2(200 char),
    USERNAME       VARCHAR2(450 char),
...
(
    ID         VARCHAR2(36 char) not null,
    JOBNAME    VARCHAR2(60 char),
    FREEMOMENT VARCHAR2(20 char),
    BUSYMOMENT VARCHAR2(20 char),
    SERVERIPS  VARCHAR2(200 char),
    ZKID       VARCHAR2(36 char),
...
(
    ...
    defaultvalue    VARCHAR2(800 char),
    originalvalue   VARCHAR2(800 char),
    datatype        VARCHAR2(1 char),
    functiontype    VARCHAR2(1 char),
    collectionname  VARCHAR2(100 char),
    collectiondatas VARCHAR2(2000 char),
    flag            DECIMAL(10, 0),
    configcomment   VARCHAR2(1024 char),
    createtime      DATE,
    updatetime      DATE,
    opuserid        VARCHAR2(36 char),
    opusername      VARCHAR2(36 char),
...
(
    ...
    checkstatus    VARCHAR2(1 char)  not null,
    checkmsg       VARCHAR2(200 char),
    createtime     DATE         not null,
    updatetime     DATE,
    opname         VARCHAR2(50 char),
    opusername     VARCHAR2(50 char),
    checkerid      VARCHAR2(36 char),
    checkername    VARCHAR2(36 char),
    checkeropinion VARCHAR2(200 char),
    opobjecttype   VARCHAR2(36 char),
...
(
  id           VARCHAR2(36 char) not null,
  examineid    VARCHAR2(36 char),
  lockedtype   VARCHAR2(1 char),
  lockedkey    VARCHAR2(100 char),
  createtime   DATE,
  opobjecttype VARCHAR2(36 char),
  lockedmode   VARCHAR2(1 char),
...
(
    ...
    beforedata BLOB,
    afterdata  BLOB,
    dataclass  VARCHAR2(200 char),
    classname  VARCHAR2(200 char),
    methodname VARCHAR2(200 char),
    param      BLOB,
...
(
  logid            VARCHAR2(36 char) not null,
  loginid          VARCHAR2(36 char),
  failpassword     VARCHAR2(50 char),
  failreason       VARCHAR2(200 char),
  logintime        DATE,
  clientip         VARCHAR2(200 char),
  serverip         VARCHAR2(200 char),
  clientsystem     VARCHAR2(50 char),
  clientbrowser    VARCHAR2(50 char),
  clientscreensize VARCHAR2(50 char),
...
(
  ...
  accesstime       DATE,
  clientip         VARCHAR2(200 char),
  serverip         VARCHAR2(50 char),
  clientsystem     VARCHAR2(50 char),
  clientbrowser    VARCHAR2(50 char),
  accessdenytype   VARCHAR2(2 char),
  clientscreensize VARCHAR2(50 char),
  menuid           VARCHAR2(36 char),
  hashverity       VARCHAR2(200 char),
...
(
  auditid        VARCHAR2(36 char) not null,
  userid         VARCHAR2(36 char) not null,
  auditcontent   VARCHAR2(1024 char),
  auditdate      DATE,
  excelname      VARCHAR2(64 char),
  aliasexcelname VARCHAR2(64 char),
  audittype      VARCHAR2(1 char),
  storetype      VARCHAR2(1 char),
  hashverity      VARCHAR2(200 char),
...
(
    id         VARCHAR2(36 char)   not null
        constraint PK_TADYNAMICREST
            primary key,
    sql        VARCHAR2(2048 char) not null,
    dsname     VARCHAR2(128 char)  not null,
    restid     VARCHAR2(255 char)  not null,
    restname   VARCHAR2(128 char)  not null,
    effective  VARCHAR2(1 char)    not null,
    createtime DATE           not null,
    createuser VARCHAR2(36 char)   not null
) distribute by replication on groupid(1);
...
(
    ...
    NAMESPACE  VARCHAR2(36 char),
    TYPE       VARCHAR2(1 char)   NOT NULL,
    EFFECTIVE  VARCHAR2(2 char)   NOT NULL,
    CREATETIME TIMESTAMP     NOT NULL,
    CREATEUSER VARCHAR2(36 char)  NOT NULL
) distribute by replication on groupid(1);
...
(
    MID             VARCHAR2(36 char)    not null,
    SENDERID        VARCHAR2(36 char)    not null,
    SENDERNAME      VARCHAR2(450 char)   not null,
    SENDDATE  		TIMESTAMP      not null,
    TITLE           VARCHAR2(200 char)   not null,
    CONTENT         CLOB           not null,
    TYPE            VARCHAR2(10 char)     not null,
    MENUUURL        VARCHAR2(200 char)       null,
    OTHERDATA       VARCHAR2(500 char)       null,
...
(
    MID             VARCHAR2(36 char)    not null,
    RECEIVERID      VARCHAR2(36 char)    not null,
    READSIGN        VARCHAR2(1 char)     not null
) distribute by replication on groupid(1);
...
(
    MID             VARCHAR2(36 char)    null,
	ANNEXID         VARCHAR2(36 char)    not null,
    ANNEXNAME       VARCHAR2(100 char)   not null,
    ANNEX           BLOB          null,
...
(
	CHATID			VARCHAR2(36 char)    not null,
	OWNER 			VARCHAR2(36 char)    not null,
	TWOUSERID       VARCHAR2(36 char)    not null,
    TWONAME         VARCHAR2(100 char)   not null,
...
(
	...
	CHATID			VARCHAR2(36 char)    not null,
	SENDERID        VARCHAR2(36 char)    not null,
    SENDERNAME      VARCHAR2(100 char)   not null,
    SENDDATE  		TIMESTAMP      not null,
	RECEIVERID      VARCHAR2(36 char)    not null,
...
CREATE TABLE "TAUSERCONNECTION" (
                                    userId NVARCHAR2(255 char) NOT NULL ,
                                    providerId NVARCHAR2(255 char) NOT NULL ,
                                    providerUserId NVARCHAR2(255 char) NOT NULL ,
                                    rank NUMBER(11) NOT NULL ,
                                    displayName NVARCHAR2(255 char) ,
                                    profileUrl NVARCHAR2(512 char) ,
                                    imageUrl NVARCHAR2(512 char) ,
                                    accessToken NVARCHAR2(512 char) NOT NULL ,
                                    secret NVARCHAR2(512 char) ,
                                    refreshToken NVARCHAR2(512 char) ,
                                    expireTime NUMBER(20)
) distribute by replication on groupid(1);

ALTER TABLE "TAUSERCONNECTION" ADD CONSTRAINT "SYS_C00187601" PRIMARY KEY (userId, providerId, providerUserId) distribute by replication on groupid(1);
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('安全策略', 'SECURITYPOLICY', '登录均可访问', '1', NULL, 2, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('安全策略', 'SECURITYPOLICY', '授权可访问', '2', NULL, 3, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('权限认证方式', 'AUTHMODE', 'Key盘', '04', NULL, 1, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO tadict(name, type, label, value, parentvalue, sort, authority, cssclass, cssstyle, remarks, createdate, createuser, version, status, field01, field02, field03, field04, field05, system, newtype) VALUES ('功能配置', 'CONFIGFUNCTIONCATEGORY', 'web安全配置', 'ta404.component.security', NULL, 60, '0', NULL, NULL, NULL, sysdate, '1', '0', '1', NULL, NULL, NULL, NULL, NULL, '1', '0');
...
INSERT INTO taresource(resourceid, presourceid, name, code, syscode, url, orderno, idpath, namepath, resourcelevel, icon, iconcolor, securitypolicy, securitylevel, resourcetype, effective, isdisplay, isfiledscontrol, createdate, createuser, uiauthoritypolicy, field01, field02, field03, field04, field05, field06, field07, field08, field09, field10, workbench, image) VALUES ('722e1cc774a14178a488eb42ef4099de', '7459c1b525934151a1d309a304933644', '润乾模板管理', NULL, 'sysmg', 'functionModules.html#/runqian', 60, '40337bdecb19484ebeb39d6c21aaca26/0415d44401b24605a21b589b6aaa349e/7459c1b525934151a1d309a304933644/722e1cc774a14178a488eb42ef4099de', '银海软件/管理系统/资源管理/润乾模板管理', '3', ' ', ' ', '2', 0, '1', '1', NULL, NULL, sysdate, '1', '0', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0', NULL);
