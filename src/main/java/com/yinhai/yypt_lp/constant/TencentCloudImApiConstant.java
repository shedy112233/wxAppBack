...
public class TencentCloudImApiConstant {
     ...
     * 基础请求地址
     */
    public static final String baseUrl = "https://console.tim.qq.com/";
    ...
    public static class HistoryMessage {
        /**拉取单聊历史数据*/
        public static final String GET_PERSON_MSG = "v4/openim/admin_getroammsg";
        /**拉取群聊历史数据*/
        public static final String GET_GROUP_MSG = "v4/group_open_http_svc/group_msg_get_simple";
