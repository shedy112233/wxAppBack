...
public class TLSSigAPIv2 {
    ...
    private static String hmacsha256(String identifier, long currTime, long expire, String base64Userbuf) {
        String contentToBeSigned = "TLS.identifier:" + identifier + "\n"
                + "TLS.sdkappid:" + TengXunImContstant.SDKAppID + "\n"
                + "TLS.time:" + currTime + "\n"
                + "TLS.expire:" + expire + "\n";
        ...
        try {
            byte[] byteKey = TengXunImContstant.IM_KEY.getBytes(StandardCharsets.UTF_8);
    ...
    private static String genUserSig(String userid, long expire, byte[] userbuf) {
        ...
        sigDoc.put("TLS.sdkappid", TengXunImContstant.SDKAppID);
    ...
    public byte[] genUserBuf(String account, long dwAuthID, long dwExpTime,
        ...
        */
        ...
        //dwSdkAppid
        userbuf[offset++] = (byte) ((TengXunImContstant.SDKAppID & 0xFF000000) >> 24);
        userbuf[offset++] = (byte) ((TengXunImContstant.SDKAppID & 0x00FF0000) >> 16);
        userbuf[offset++] = (byte) ((TengXunImContstant.SDKAppID & 0x0000FF00) >> 8);
        userbuf[offset++] = (byte) (TengXunImContstant.SDKAppID & 0x000000FF);
